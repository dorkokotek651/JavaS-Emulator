...
/**
 * Utility class for managing application styles and CSS classes.
 * Provides centralized styling functionality to replace inline styles.
 */
public class StyleManager {
    ...
    /**
     * Applies the main stylesheet to the given scene.
     * Should be called once when setting up the primary scene.
     * 
    ...
    /**
     * Applies normal input field styling.
     * 
     ...
     * 
     * @param field the text field to style as error
     */
    ...
    /**
     * Applies file path display styling.
     * 
     * @param label the label to style
     */
    ...
    /**
     * Applies instruction table styling.
     * 
    ...
    /**
     * Applies variable table styling.
     * 
     * @param table the table to style
     */
    ...
    /**
     * Clears all custom styling from an input field.
     * 
     * @param field the text field to clear styling from
     */
    public static void clearInputFieldStyling(TextField field) {
        field.getStyleClass().removeAll(INPUT_FIELD, INPUT_FIELD_ERROR);
        field.setStyle(""); // Clear any inline styles
    }
    
    /**
     * Removes all styling classes from a button.
     * 
     * @param button the button to clear styling from
     */
    public static void clearButtonStyling(Button button) {
        ...
        button.setStyle(""); // Clear any inline styles
    }
}
